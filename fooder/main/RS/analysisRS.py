...
ap.add_argument("-o","--gpsOffset",required = True,help = "Path to the answer json file")
...
gS = gpsSearcher(float(args['gpsOffset']))
...
# should make more beautiful json format
	...
	for (score, imageName) in results:
		...
		ansIndex[i]=(fooderList[imageName][0],fooderList[imageName][3],fooderList[imageName][4],score)
		i+=1
		#should fixed!!
